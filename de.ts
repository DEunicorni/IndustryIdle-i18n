export const DE = {
    ...
    IndustryZoneMaxBuildingLevelDesc: "Max. Stufe der Gebäude, die von dieser Industriezone beeinflusst werden",
    ...
    ExtraBuildingPermitDesc:
        "Füge zusätzliche Baugenehmigungen zur aktuellen Karte hinzu - Dies wird die Kostenkurve nicht erhöhen",
    PanelPositionDescV2:
        "Zeige das Seiten-Fenster links, rechts oder automatisch (hängt von der selektierten Zelle ab) an. Funktioniert nur im Landscape-Modus",
    ...
    AllowPortraitModeDesc:
        "Aktiviert den Porträtmodus (Experimentel), der Bildschirm wird, basierend auf den Sensoren und Einstellungen deines mobilen Gerätes, gedreht",
    IndustryZoneProductivityBoostDesc:
        "Jedes Tier oder alle 10 Stufen einer Industriezone erzeugen einen 10% Ausgabeboost für zugehörige Gebäude",
    Auckland: "Auckland",
    AucklandBonus:
        "<li>All Ressourcenvorkommen sind im Stadtgrundriss von Auckland in der Mitte der Karte angeordnet. </li><li>Unique Building: Hydro Power Plant</li><li>Einzigartige Richtlinie: Minenverstärker</li><li>Einzigartige Richtlinie: Elektronischer Fischteich </li><li>Fischteiche können auf jeder Zelle gebaut werden</li>",
    MineBooster: "Minenverstärker",
    MineBoosterDesc:
        "Eine arbeitende Mine erzeugt einen Kapazitätsbonus von 100% für alle angrenzenden Minen und Gebäude, die deren Austrag verbrauchen",
    HydroPowerPlant: "Hydro Power Plant",
    ElectricFishPond: "Elektronischer Fischteich",
    ElectricFishPondDesc: "Jede arbeitende Hydro Power Plant bietet einen 20% Kapazitätsbonus für alle Fischteiche auf der Karte",
    AccountLimitedDescV2: "Dein Account erfüllt nicht alle benötigten Vorraussetzungen",
    AccountLimitedActionV2: "Lese das FAQ über limitierte Accounts",
    CropOutputx2: "Moderner Dünger",
    CropOutputx2Desc: "Äcker und Gewächshäuser erbringen doppelte Erträge, aber der Transport der Erträge kostet 2x Kraftstoff",
    MeatProductionx2: "Livestock Steroid",
    MeatProductionx2Desc:
        "Geflügel-, Schweine- und Rinderzuchtbetriebe, sowie Fischteiche und Futterhersteller haben 2x Kapazität, aber verbrauchen doppelt so viel Strom",
    HydroFarming: "Hydro Farming",
    HydroFarmingDesc: "Jeder arbeitende Staudamm erzeugt einen 20% Kapazitätsbonus für alle Äcker und Gewächshäuser auf der Karte",
    ...
    ProduceAllCropsDesc: "Äcker und Gewächshäuser können auch Ressourcen produzieren, die nicht auf der Karte sind",
    ResearchAgreement: "Research Agreement",
    ResearchAgreementDesc: "Für jeden abgeschlossenen Spielerhandel erhälst du 10 Minuten Forschungszeit",
    NewsEffectx2V2: "Pressekonferenz",
    NewsEffectx2DescV2: "Alle Marktneuigkeiten sind 50% effektiver",
    AutoSellCapacityMultiplierV2: "Extra Verkaufskapazität",
    AutoSellCapacityMultiplierDescV2: "Gewährt, zusätzlich zu der bestehenden automatischen Verkaufsmenge, zusätzliche Kapazität beim automatischen Handel",
    AutoSellCapacity: "automatische Verkaufsmenge",
    AutoSellCapacityDescV2:
        "Maximale Anzahl an Ressourcen, die automatisch pro Sekunde verkauft werden können, prozentuale gemessen an deiner Produktion dieser Ressource",
    AutoSellCapacityExtraPercentageFromSwiss: "Extra Prozente von Schweizer Upgrades und Boni: %{n}%",
    BaselineAutoSellCapacity: "Baseline autom. Verkaufskapazität: %{amount}",
    AchievementAuckland100: "Hoiho",
    AchievementAuckland100Desc: "Verdiene in einem einzigen Durchgang 100 Schweizer Franken in Auckland",",
    AchievementAuckland500: "Whio",
    AchievementAuckland500Desc: "Verdiene in einem einzigen Durchgang 500 Schweizer Franken in Auckland",
    AchievementAuckland1000: "Kiwi",
    AchievementAuckland1000Desc: "Verdiene in einem einzigen Durchgang 1000 Schweizer Franken in Auckland",
    ExternalManageYourSave: "Speicherstand im- oder exportieren",
    ExternalManageYourSaveDesc:
        "Aufgrund technischer Einschränkungen, muss das Importieren und Exportieren von Spielständen auf unserer offiziellen Webseite durchgeführt werden",
    MREPlant: "Meal, Ready-To-Eat Plant",
    PlayerTradeTaxCreditProduction: "Tax Credit: Production",
    PlayerTradeTaxCreditProductionDescV2:
        "Diese Steuererleichterung basiert auf der Menge von %{res}, die du seit der letzten Marktpreisaktualisierung produziert hast, Du hast %{produced} produziert und %{used} bereits gehandelt.",
    PlayerTradeTaxCreditMarketCap: "Tax Credit: Market Cap",
    PlayerTradeTaxCreditMarketCapDesc:
        "Diese Steuererleichterung basiert auf %{percentage} of your market cap, can be upgraded via Swiss Upgrade/Boost. Total credit amount is %{total} and you have used %{used}",
