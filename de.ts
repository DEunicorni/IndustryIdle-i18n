export const DE = {
    ...
    TotalPledgedValueDesc:
        "Dein erster Beitrag zählt für das Crowdfunding-Ziel. Nachfolgende Beiträge erhöhen den gesamten Beitragswert, zählen aber nicht zum Ziel",
    ...
    HighPowerPriorityDesc: "Wenn du das einschaltest, zwackt das Gebäude Strom von anderen Gebäuden ab",
    ...
    WarehouseBuildingPermitSaveDesc: "Für je zwei Lagerhäuser erhältst du eine kostenlose Baugenehmigung",
    PolicySearchPlaceholder: "Gib den Namen der Richtlinie ein",
    ...
    SwissBoostDesc:
        "Schweizer Boost wirkt nur auf die jetzige Stadt - und muss nach dem Start in einer neuen Stadt wieder aktiviert werden",
    ...
    FarmlandOfflineFarmingDesc:
        "Äcker auf natürlichen Wasserquellen produzieren auch offline. Beeinflusst durch Schweizer Upgrades und Offlineerwerbszeit",
    ...
    StreamAutoApproveDesc: "Erlaubt es Spielern deinem Stream anzuschauen ohne individuelle Anfragen stellen zu müssen.",
    ...
    KansasCityBonus:
        "<li>Äcker und Gewächshäuser haben doppelte Produktivität</li><li>Kostenloser Maistransport</li><li>Für jede Stufe verstärken Staudämme angrenzende Äcker um 5%</li><li>Je zwei Äcker bieten eine kostenlose Baugenehmigung</li><li>Die 'Die Sonne geht nie unter' Richtlinie lässt Äcker 100% der Zeit arbeiten (auch offline)</li><li>Doppelte Handelsquota beim Handeln von Mais</li><li>Lebensmittelverarbeitungsbetrieb sind freigeschaltet</li>",
    KansasCityHydroDamBoost: "Kansas City einzigartiger Bonus: Dieser Staudamm verstärkt angrenzende Äcker um %{boost}",
    ...
    IstanbulBonus:
        "<li>Tower-Defense-Modus: Konvertiere deine Waffen zu Schaden gegen Eindringlinge und verdiene zusätzliches Geld/li><li>Army commands have 2x capacity</li><li>Tank factories have 2x capacity</li><li>Gun factories have 2x capacity</li><li>Missile factories have 2x capacity</li><li>Dynamite factories have 2x productivity</li>",
